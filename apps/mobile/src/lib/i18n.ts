...
const translations = {
  en: {
    ...
    cancelReminderBody: 'This reminder will be cancelled.',
    loading: 'Loading...',
    noContent: 'No content',
    updatedAt: 'Updated',
    archiveNote: 'Archive note',
    archiveNoteBody: 'This note will be moved to archive.',
    ...
    disconnectTelegramBody: 'You will no longer receive Telegram reminders.',
    confirmationEmailSent: 'A confirmation email has been sent to your new address. Please verify it.',
  ...
  ru: {
    ...
    cancelReminderBody: 'Это напоминание будет отменено.',
    loading: 'Загрузка...',
    noContent: 'Нет содержимого',
    updatedAt: 'Обновлено',
    archiveNote: 'Архивировать заметку',
    archiveNoteBody: 'Заметка будет перемещена в архив.',
    ...
    reminderTitlePlaceholder: 'Название напоминания',
    addDetails: 'Добавить описание...',
    openInTelegram: 'Открыть в Telegram',
    failedToSave: 'Не удалось сохранить. Попробуйте ещё раз.',
    willBeRemoved: '«{name}» будет удалён.',
    noteCount: '{count} заметок',
    reminderCount: '{count} напоминаний',
    folders: 'Папки',
    disconnectTelegram: 'Отключить Telegram',
    disconnectTelegramBody: 'Вы больше не будете получать напоминания в Telegram.',
    confirmationEmailSent: 'Письмо с подтверждением отправлено на новый адрес. Подтвердите его.',
